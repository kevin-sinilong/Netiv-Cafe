    ...
    confirmOrderBtn.addEventListener('click', async function() {
        ...
        try {
            ...
            if (data.success) {
                ...
                generateReceiptInNewTab(cart, total, cashPaid, change, data.order_id);
...
// ✅ GENERATE RECEIPT IN NEW TAB FUNCTION
function generateReceiptInNewTab(cartItems, total, cashPaid, change, orderId) {
